...
module.exports = class BotInfoCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['bot', 'bi'],
      usage: 'botinfo',
      description: 'Fetches shadow\'s bot information.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('shadow\'s Bot Information')
      .setDescription(oneLine`
        shadow is an open source, fully customizable Discord bot that is constantly growing.
      ...
      .addField(
        'Links', 
        '   *** https://www.youtube.com/channel/UCs9VrxSOvNqX2rxeoO_HwKA ***    ' + 

        '   *** https://discord.gg/Af8KdsXYgX ***    ' +

        '   ***    https://discord.gg/djs    ***   '
      )
      .setImage('https://raw.githubusercontent.com/sabattle/shadowBot/develop/data/images/shadow_Title.png')
