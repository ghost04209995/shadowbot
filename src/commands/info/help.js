  ...
  run(message, args) {
    ...
    if (
      ...
      embed // Build specific command help embed
        ...
        .setThumbnail('https://cdn.discordapp.com/attachments/839225603219259402/840652140099797002/7cb35f843186aca91c2ebad0ea31d5a5.png')
