module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`shadow has left ${guild.guild_name}`);
  }

  client.logger.info('shadow is now online');
  client.logger.info(`shadow is running on ${client.guilds.cache.size} server(s)`);
};
